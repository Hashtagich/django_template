...
SECRET_KEY = os.environ.get("BACKEND_SERVER__SECRET_KEY")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = bool(os.environ.get("BACKEND_SERVER__DEBUG", "True") == "True")

ALLOWED_HOSTS = os.getenv("BACKEND_SERVER__DJANGO_ALLOWED_HOSTS").split(" ")
CSRF_TRUSTED_ORIGINS = os.getenv("BACKEND_SERVER__CSRF_TRUSTED_ORIGINS").split(" ")
...
LANGUAGE_CODE = os.environ.get("BACKEND_SERVER__LANGUAGE_CODE")

TIME_ZONE = os.environ.get("BACKEND_SERVER__TIME_ZONE")
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'TITLE API',
    'DESCRIPTION': f'Документация по API.',
    'VERSION': '1.0.0',
